...
module Discord
  module REST
    ...
    def create_channel_invite(channel_id : UInt64 | Snowflake, max_age : Int32 = 0,
                              max_uses : Int32 = 0, temporary : Bool = false)
      json = encode_tuple(
        max_age: max_age,
        max_uses: max_uses,
        temporary: temporary
    ...
    def modify_guild(guild_id : UInt64 | Snowflake, name : String? = nil, region : String? = nil,
                     verification_level : Int32? = nil, afk_channel_id : UInt64 | Snowflake | Nil = nil,
    ...
    def create_guild_role(guild_id : UInt64 | Snowflake, name : String? = nil,
                          permissions : Permissions? = nil, colour : Int32 = 0,
    ...
    def modify_guild_integration(guild_id : UInt64 | Snowflake, integration_id : UInt64 | Snowflake,
                                 expire_behaviour : Int32, expire_grace_period : Int32,
